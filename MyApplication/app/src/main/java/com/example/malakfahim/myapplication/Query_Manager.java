 ...
 * Created by Malak Fahim on 8/8/2016.
 */
...
public class Query_Manager {
    ...
    public int Insert_User(String User_name, String Name, String Telephone, String Pass, String dob)
    {
        Sql = "Insert Into khadem(Name,user_name,password,phone,dop)Values"
                + "('" + Name + "','" + User_name + "','" + Pass + "','" + Telephone+ "','" + dob + "')";
        return (int)DBM.ExecuteInsert(Sql);

    }

    public Cursor isUser(String USER, String PASS) {
        Sql = "Select * from khadem where user_name = '" + USER + "' AND password = '" + PASS + "'";
        return DBM.ExecuteSelect(Sql);
    }


    public int INSERT_ma5dom(String name, String year,String priest,String dob,String phone,String address)
    {
        Sql = "Insert Into ma5dom(Name,year,abe3traf,dateofbirth,phone,address)Values"
                + "('" + name + "','" + year + "','"+priest+"','"+dob+"','"+phone+"','"+address+"')";
    ...
    public Cursor getchildren() {
        Sql = "select ID as _id,Name" +
                " from ma5dom";
        return DBM.ExecuteSelect(Sql);
    }

    public Cursor getma5dom_by_ID(Integer id) {
        Sql = "select ID as _id,Name,phone,address,dateofbirth,year,abe3traf,About" +
                " from ma5dom where ID="+id;              //ID
        return DBM.ExecuteSelect(Sql);
    }
    ...
    public Cursor get_about_by_ID(Integer id) {
        Sql = "select About as _id" +
                " from ma5dom where ID="+id;              //ID
        return DBM.ExecuteSelect(Sql);
    }
    ...
    public Integer INSERT_info_ma5dom(String info,Integer id) {
        Sql = "UPDATE ma5dom set About ='" + info + "' where ID="+id;
